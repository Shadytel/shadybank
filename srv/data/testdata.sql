...
insert into accounts (name, partner) values ('Beerocracy Loans', true);
...
insert into nfc_keys values('\x04\x53\x9b\xb9\xbf\x61\x80', 'BREAKMEI', 'FYOUCAN!', '\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
